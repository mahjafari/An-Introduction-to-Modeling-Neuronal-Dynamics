"""
Chapter 5 - Beyond the Hodgkin-Huxley Model: the RTM model.

Integrates the Reduced Traub-Miles (RTM) pyramidal-cell model with RK4
and plots the resulting voltage trace under constant applied current.
"""
