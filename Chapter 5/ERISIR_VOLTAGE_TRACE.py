"""
Chapter 5 - Beyond the Hodgkin-Huxley Model: the Erisir model.

Integrates the Erisir et al. fast-spiking interneuron model with RK4 and
plots its voltage trace, for comparison with the RTM and WB models.
"""
