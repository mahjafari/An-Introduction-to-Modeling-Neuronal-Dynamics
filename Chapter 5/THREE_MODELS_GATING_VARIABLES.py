"""
Chapter 5 - Beyond the Hodgkin-Huxley Model.

Compares the steady-state gating-variable curves (alpha/beta functions)
of the RTM, Wang-Buzsaki (WB), and Erisir neuron models side by side.
"""
