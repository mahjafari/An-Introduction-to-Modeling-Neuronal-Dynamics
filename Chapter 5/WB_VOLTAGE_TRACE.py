"""
Chapter 5 - Beyond the Hodgkin-Huxley Model: the Wang-Buzsaki model.

Integrates the Wang-Buzsaki (WB) interneuron model with RK4 and plots
the resulting voltage trace under constant applied current.
"""
