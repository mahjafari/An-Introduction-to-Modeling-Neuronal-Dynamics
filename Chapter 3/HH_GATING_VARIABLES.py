"""
Chapter 3 - The Hodgkin-Huxley Model: gating variables.

Plots the steady-state activation/inactivation curves (m_inf, n_inf, h_inf)
and the voltage-dependent time constants of the Hodgkin-Huxley gating
variables m, n, and h as functions of membrane potential.
"""
