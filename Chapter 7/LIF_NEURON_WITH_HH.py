"""
Chapter 7 - The Leaky Integrate-and-Fire Model.

Fits a leaky integrate-and-fire (LIF) neuron's membrane time constant to
the Hodgkin-Huxley model's ionic currents, comparing the two descriptions
of subthreshold membrane dynamics.
"""
