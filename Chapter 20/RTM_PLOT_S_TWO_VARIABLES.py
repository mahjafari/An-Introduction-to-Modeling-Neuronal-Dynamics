...
Simulates the two-variable (q, s) kinetic scheme for synaptic
transmission in an RTM neuron and compares rise/decay behaviour across
parameter values.
"""
...
for tau_r in tau_r_values:
  ...
  plt.xlabel('t [ms]')
  plt.ylabel('s')
  plt.title(r'$\tau_d = {} \ ms, \ \tau_r = {} \ ms, \ \tau_{{d,q}} = {} \ ms$'.format(tau_d, tau_r, tau_dq))
