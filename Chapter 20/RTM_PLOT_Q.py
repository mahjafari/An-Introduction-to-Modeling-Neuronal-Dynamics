...
Simulates an RTM neuron together with the auxiliary gating variable q
used in the two-variable kinetic scheme for synaptic transmission.
"""
...
def spike(x, t):
  ...
  dqdt = ((1 + np.tanh(v/10))*(1 - q))/(2 * tau_r) - (q / tau_d)
  return [dvdt, dndt, dhdt, dqdt]
