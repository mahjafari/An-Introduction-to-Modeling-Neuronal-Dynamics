"""
Chapter 12 - Two-Dimensional Reduction of the RTM Model.

Computes the Jacobian of the two-dimensional RTM reduction via automatic
differentiation and evaluates its eigenvalues to classify the stability
of the fixed point.
"""
