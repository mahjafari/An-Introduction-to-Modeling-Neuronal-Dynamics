...
Simulates a pair of gap-junction-coupled Wang-Buzsaki neurons in the
subthreshold regime and examines how gap-junction strength shapes their
subthreshold voltage coupling.
"""
