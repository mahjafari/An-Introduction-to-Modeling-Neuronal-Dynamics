...
Integrates the two-dimensional reduction of the Hodgkin-Huxley model
(voltage V and gating variable n, with m and h slaved to V) and plots
the resulting voltage trace.
"""
