...
Simulates the normal form of a subcritical Hopf bifurcation with a
stabilizing quintic term (dr/dt = I*r + r^3 - r^5) and plots trajectories
in the phase plane across a range of I.
"""
