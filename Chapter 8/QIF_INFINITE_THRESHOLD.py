"""
Chapter 8 - The Quadratic and Theta Integrate-and-Fire Models.

Uses the closed-form analytical solution of the normalized QIF model in
the limit of an infinite threshold and reset, and plots the voltage trace.
"""
