"""
Chapter 30 - Pyramidal-Interneuron Network Gamma (PING) Rhythms.

Simulates a network of Hodgkin-Huxley-type excitatory and inhibitory
cells coupled through synapses, generating a PING gamma-frequency
network oscillation.
"""
